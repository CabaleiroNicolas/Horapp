...
import com.horapp.presentation.dto.response.ValidationExceptionResponse;
...
public class GlobalHandlerException {
    ...
    public ResponseEntity<ExceptionResponse> majorNotFoundException(MajorNotFoundException notFoundException, HttpServletRequest request){
        return getExceptionNotFound(notFoundException.getMessage(), request);
    }
    ...
    public ResponseEntity<ExceptionResponse> categoryNotFoundException(CategoryNotFoundException exception, HttpServletRequest request){
        return getExceptionNotFound(exception.getMessage(), request);
    }
    ...
    private static ResponseEntity<ExceptionResponse> getExceptionNotFound(String exception, HttpServletRequest request) {
        ExceptionResponse exceptionResponse = new ExceptionResponse(
                exception,
